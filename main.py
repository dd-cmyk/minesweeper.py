...
class Square(games.Sprite):
    HID = [games.load_image("assets/hidden.png", transparent=False), games.load_image("assets/question.png", transparent=False), games.load_image("assets/flag.png", transparent=False)]
    NUMS = [games.load_image("assets/blank.png", transparent=False), games.load_image("assets/1.png", transparent=False), games.load_image("assets/2.png", transparent=False), games.load_image("assets/3.png", transparent=False),
            games.load_image("assets/4.png", transparent=False), games.load_image("assets/5.png", transparent=False), games.load_image("assets/6.png", transparent=False),
            games.load_image("assets/7.png", transparent=False),
            games.load_image("assets/8.png", transparent=False)]  # TODO write a lambda function to handle that
    MINES = [games.load_image("assets/mine.png", transparent=False), games.load_image("assets/mine_red.png", transparent=False), games.load_image("assets/mine_x.png", transparent=False)]
...
class Pointer(games.Sprite):
    IMG = games.load_image("assets/pointer.png", transparent=False)
...
class Game(object):
    ...
    def lose(self):
        self.mouse.destroy()
        self.show()
        lose_sound = games.load_sound("assets/lose.wav")
        lose_sound.play()
        lose_msg = games.Message(value = "YOU LOST!", size=50, color = color.red, x = 500, y = 100, after_death=games.screen.quit, lifetime=5*games.screen.fps)
    ...
    def win(self):
        ...
        lose_sound = games.load_sound("assets/win.wav")
        lose_sound.play()
        win_msg = games.Message(value="YOU WIN!", size=50, color=color.dark_green, x=400, y=100, after_death=games.screen.quit, lifetime=5*games.screen.fps)
...
def main(x=10, y=10, mines=7):
    games.screen.background = games.load_image("assets/grey.png", transparent=False)
